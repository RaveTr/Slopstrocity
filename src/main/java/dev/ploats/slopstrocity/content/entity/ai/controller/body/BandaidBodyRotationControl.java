package dev.ploats.slopstrocity.content.entity.ai.controller.body;
...
public class BandaidBodyRotationControl extends BodyRotationControl {
    ...
    protected boolean isOwnerMoving() {
        ...
        return dxSqr + dzSqr > (owner instanceof AnimatableMonster animatableOwner ? animatableOwner.getMovementThreshold() : 2.500000277905201E-7);
    }
