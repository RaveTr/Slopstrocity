...
public abstract class AnimatableProjectile extends Projectile implements WrappedAnimatable {
    ...
    public AnimatableProjectile(EntityType<? extends AnimatableProjectile> pEntityType, Level pLevel) {
