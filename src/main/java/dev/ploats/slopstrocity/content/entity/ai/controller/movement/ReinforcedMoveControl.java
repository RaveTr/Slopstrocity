package dev.ploats.slopstrocity.content.entity.ai.controller.movement;
...
public class ReinforcedMoveControl extends MoveControl {
    ...
    public boolean isWalkable(float relativeXOffset, float relativeZOffset) {
        ...
        return ownerPathNav == null || (curNodeEvaluator == null || curNodeEvaluator.getPathType(new PathfindingContext(mob.level(), mob), Mth.floor(this.mob.getX() + relativeXOffset), this.mob.getBlockY(), Mth.floor(this.mob.getZ() + relativeZOffset)) == PathType.WALKABLE);
    }
}